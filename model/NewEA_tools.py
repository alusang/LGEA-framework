...
class MultiModalEncoder(nn.Module):
    ...
    def __init__(self, args,kgs,
                 ...
                 attr_input_dim=1000,mask_i = None):
        ...
        # Fusion Encoder
        #########################
        self.fusion = MultiModalFusion(self.args, modal_num=self.args.inner_view_num)
    ...
    def forward(self,
        ...
        if self.args.w_img:
            ...
            img_emb = img_emb * self.mask_i.unsqueeze(-1)
        else:
            img_emb = None
        if self.args.w_rel:
        ...
        if self.args.w_attr:
            ...
            att_emb = att_emb * torch.from_numpy(self.kgs["mask_a"]).to(att_emb.device).unsqueeze(-1)
        else:
            att_emb = None
